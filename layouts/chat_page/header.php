...
<head>
    ...
    <link href="<?php echo Registry::load('config')->site_url.'assets/css/combined_css_chat_page_libraries.css'.$cache_timestamp; ?>" rel="stylesheet">
    ...
    <link rel="preload" href="<?php echo Registry::load('config')->site_url.'assets/css/combined_css_chat_page_deferred.css'.$cache_timestamp; ?>" as="style" onload="this.onload=null;this.rel='stylesheet'">
    ...
    <script src="<?php echo Registry::load('config')->site_url.'assets/js/combined_js_chat_page_libraries.js'.$cache_timestamp; ?>"></script>

    <?php
    if (Registry::load('current_user')->logged_in) {
        ?>
        <script src="<?php echo Registry::load('config')->site_url.'assets/js/combined_js_chat_page_libraries_2.js'.$cache_timestamp; ?>"></script>
        <script src="<?php echo Registry::load('config')->site_url.'assets/js/combined_js_chat_page_libraries_3.js'.$cache_timestamp; ?>"></script>
        <?php
    }
    ?>
